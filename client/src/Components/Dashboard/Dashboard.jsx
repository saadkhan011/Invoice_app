...
import { Ivancik, Rocket_white } from '../../assets/images';
import AOS from 'aos';
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 text-end">
                                                        <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                                                            <i class="fa-sharp fa-solid fa-coins text-lg opacity-10"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body p-3">
                                                <div class="row">
                                                    <div class="col-8">
                                                        <div class="numbers">
                                                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Sales Amount</p>
                                                            <h5 class="font-weight-bolder mb-0">
                                                                2,300
                                                            </h5>
                                                        </div>
                                                    ...
                                                    <div class="col-4 text-end">
                                                        <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                                                            <i class="fa-solid fa-arrow-up-wide-short text-lg opacity-10"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body p-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 text-end">
                                                        <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                                                            <i class="fa-solid fa-file-invoice text-lg opacity-10"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body p-3">
                                                <div class="row">
                                                    <div class="col-8">
                                                        <div class="numbers">
                                                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Paid Invoices</p>
                                                            <h5 class="font-weight-bolder mb-0">
                                                                7
                                                            </h5>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="d-flex flex-column h-100">
                                                            ...
                                                            <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="javascript:;">
                                                                Read More
                                                                <i class="fa-solid fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="card h-100 p-3">
                                            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                                                style={{ "background-image": `url(${Ivancik})` }}>
                                        ...
                                        <div class="row align-items-center justify-content-lg-between">
                                            <div class="col-lg-6 mb-lg-0 mb-4">
                                                <div class="copyright text-center text-sm text-muted text-lg-start">
                                                    ...
                                                    <a href="https://" class="font-weight-bold" target="_blank"> Saad Khan </a>
                                                    for a better web.
                                                </div>
                                            </div>
                                        </div>
